// HyperlienRenderer.js
export class HyperlienRenderer {
  init(params) {
    this.params = params;
    ...
    const href  = String(raw || ("https://www.festivaloffavignon.com/resultats-recherche?recherche="+encodeURIComponent(params.data?.Activite || '')));
