...
function wireAgTouchScrollRouter(gridId) {
  ...
  const MAX_VY = 2.0;      // px/ms (souvent un peu moins agréable que X si trop haut)

  const BASE_FRICTION_X = 0.0038;
  const BASE_FRICTION_Y = 0.0042; // un poil plus “freiné” en Y
